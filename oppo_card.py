...
def dist_plot(player,ax,team_color,team_alt_color,stat='FP',df=season_market):
    ...
    oppo_text = ax.text(xstat_val,ax.get_ylim()[1]*0.825,stat_dict[stat][2], ha='center', va='center', fontsize=12, weight=800, color=team_alt_color, bbox=dict(facecolor='white', alpha=1, edgecolor=team_color, linewidth=2))
    oppo_text.set_path_effects([patheffects.withStroke(linewidth=2, foreground=team_color)])
